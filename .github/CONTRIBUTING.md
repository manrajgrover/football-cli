...
Please go through [project issues](https://github.com/manrajgrover/football-cli/issues) and [pull requests](https://github.com/manrajgrover/football-cli/pulls) to check for duplicates before picking up an issue.
